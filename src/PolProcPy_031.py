#!/usr/bin/python
"""
Version 3.1 for the Polonator Processor machine.
Major difference from previous:
- Removed "initialize_processor.pl" from "updateProcesses" because it was there
  incorrectly.
 
- Fixed part of the QProcess crashing issue.  STILL NEED TO FIX CYCLE QUALITY
  QPROCESSES SECTION
 
- Added an autoswitch button in the Cycle Quality tab for switching the output
  tabs when something is selected in the left column.
"""
...
#===============================================================================
#       Software Version
        self.aboutVersion.setText("Version 0.3.1")
        self.aboutDate.setText("11/02/2010")
#===============================================================================
...
#===============================================================================
    ...
    def polonatorinitialize(self):
        ...
        self.polonator_initializestatus.setText(QApplication.translate("MainWindow",
                                                                       "RUNNING"))
        cmd = "perl initialize_processor.pl"
        self.polonator_initialize.setEnabled(False)
        self.polonator_process.setEnabled(False)
        global nextFunc
        global args
...
#===============================================================================
    ...
    def proc_readyRead_2(self):
        ...
        log = open("PolonatorProcessorLog.txt",'w')
        outWin.append(str(proc_2.readLine()).strip('\n'))
        log.write(str(proc_2.readLine()).strip('\n'))
        log.close()
