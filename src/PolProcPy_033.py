...
"""
Version 3.3 for the Polonator Processor machine.
Major difference from previous:
- Trying to fix QC tab
- Adding new window to enlarge images
"""
...
#===============================================================================
#       Software Version
        self.aboutVersion.setText("Version 0.3.3")
        self.aboutDate.setText("12/03/2010")
#===============================================================================
...
#===============================================================================
    ...
    def polonatorinitialize(self):
        ...
        self.polonator_initializestatus.setText(QApplication.translate("MainWindow",
                                                                       "RUNNING"))
        cmd = "python initialize_processor.py"
        self.polonator_initialize.setEnabled(False)
        self.polonator_process.setEnabled(False)
        global nextFunc
        global args
...
#===============================================================================
    ...
    def start_QC(self):
        ...
        if self.cycleListPending.selectedItems() == []:
            outWin.append("No cycles selected.")
            return
        ...
        for item in pendlist:
            ...
            cmdlist1.append(cmd2)
        nextFunc = "self.start_QC_proc()"
        args = ['del cmdlist1[0]']
        self.proc_start(cmdlist1[0])
        return

    def start_QC_proc(self):
        """Populate Pending Cycles list"""
        self.startQC.setEnabled(False)
        self.cycleListPending.setEnabled(False)
        global nextFunc
        global args
...
#===============================================================================
    ...
    def raw_Display(self):
        ...
        if red != "None" or green != "None" or blue != "None":
            ...
            self.polonator_textarea.append("ERROR:\tRed, Green, and Blue dropdowns are " +
                                           'all set to "None."\n' + 
                                           "\tNothing to show.")
...
#===============================================================================
    ...
    def basecaller_RunBasecallerButton(self):
        ...
        cmd2 = ("python basecall.py " + str(self.basecallerReadfileFN.text()) +
...
#===============================================================================
    ...
    def updateProcesses1(self):
        ...
        cmd2 = "python find_running_processes.py"
