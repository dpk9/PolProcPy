...
"""
Version 0.3.4 for the Polonator Processor machine.
...
#===============================================================================
#       Software Version
        self.aboutVersion.setText("Version 0.3.4")
        self.aboutDate.setText("12/08/2010")
#===============================================================================
...
#===============================================================================
    ...
    def start_QC(self):
        ...
        for item in pendlistQC:
            ...
            cmdQC1 = (["python disp_delta.py tetrahedra/" + seltext +
                    "-QC.delta QC-" + seltext + "-delta"])
            cmdQC2 = ["python disp_regQC.py " + seltext]
    ...
    def finished_QC(self, rv):
        if cycleQCitem[0] != 'pass':
            ...
            try:
                ...
                self.polonator_textarea.append("ERROR:\tCan't find either %(pendlocation)s or %(complocation)s." %vars())
